"""
data/adapters/prostate/muregpro.py  ·  µ-RegPro prostate TRUS adapter
=======================================================================

Subset of the µ-RegPro MR-TRUS registration challenge stored under muregpro/.
...
class MuRegProAdapter(BaseAdapter):
    DATASET_ID = "muregpro"
    ...
    def iter_entries(self) -> Iterator[USManifestEntry]:
        ...
        if not split_dirs:
            log.warning("muregpro: no train/val/test splits under %s", self.root)
            return
        ...
        for split_dir in split_dirs:
            ...
            for vol_path in volumes:
                ...
                yield self._make_entry(
                    ...
                    source_meta={"case_id": case_id, "split_dir": split_name},
                )
