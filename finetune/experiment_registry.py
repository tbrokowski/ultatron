...
EXPERIMENTS: dict[str, ExperimentSpec] = {
    ...
    "lus": ExperimentSpec("lus", "LUS — patient-level MIL", "representative", "ultatron_ft_lus_", "val_auc_macro", "mil", (("val_auc_tb", "AUC TB", False), ("val_auc_pneumonia", "AUC Pneumonia", False), ("val_auc_covid", "AUC COVID", False), ("val_auc_macro", "AUC Macro", False))),
