...
class FusionBlock_v3(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        self.norm = norm_layer(hidden_dim)
        self.self_attention = Cross_SS2Dv3(
            d_model=hidden_dim,
            dropout=attn_drop_rate,
            d_state=d_state,
            **kwargs
...
class CSSFVSSLayer_v3(nn.Module):
    def __init__(
        self,
        hidden_dim: int,
        depth: int = 1,
...
# =====================================================
def vmamba_tiny_s2l5(channel_first=True, num_classes=1000):
    return VSSM(
...
def vmamba_small_s2l15(channel_first=True, num_classes=1000):
    return VSSM(
...
def vmamba_tiny_m2(num_classes):
    return VSSM(
