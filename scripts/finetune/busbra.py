#!/usr/bin/env python3
"""BUS-BRA breast lesion segmentation — all backbones, one GPU."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Finetune comparison: BUS-BRA")
    add_common_args(parser)
    args = parser.parse_args()
    launch_experiment("busbra", args)
