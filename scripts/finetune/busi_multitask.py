#!/usr/bin/env python3
"""BUSI seg + cls multitask — all backbones, one GPU."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Finetune comparison: BUSI multitask")
    add_common_args(parser)
    args = parser.parse_args()
    launch_experiment("busi_multitask", args)
