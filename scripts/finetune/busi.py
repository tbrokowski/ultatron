#!/usr/bin/env python3
"""BUSI tumour segmentation + classification — all backbones, one GPU."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Finetune comparison: BUSI")
    add_common_args(parser)
    args = parser.parse_args()
    launch_experiment("busi", args)
